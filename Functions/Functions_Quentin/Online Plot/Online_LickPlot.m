...
plot(-20,-20,'ko','MarkerSize',MS_trial); %square legend, ie reward
plot(-20,-20,'ks','MarkerSize',MS_trial); %circle legend, ie omission
...
legend('Type1','Type2','Hit','Missed','Location','east');
legend('boxoff');
...
minx=-3;    maxx=4;     xstep=1;    xtickvalues=minx:xstep:maxx;
