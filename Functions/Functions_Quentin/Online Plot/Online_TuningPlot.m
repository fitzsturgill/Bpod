function figData=Online_TuningPlot(action,S,TrialSequence,figData,Nidaq,thistrial)
...
title('Trials sequence'); xlabel('Trials'); ylabel('Frequency(Hz)');
...
title('Tuning Curve'); xlabel('Frequency (Hz)'); ylabel('DF/F');
